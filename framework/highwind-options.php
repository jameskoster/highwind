    ...
    public static function highwind_render() {
        ...
        <style type="text/css">
                <?php
                    ...
                    self::generate_css( apply_filters( 'highwind_link_color_background_selectors', $selectors = 'input[type="submit"], .button, input[type="button"], .navigation-post a, .navigation-paging a, .header, .comments .bypostauthor > .comment-body .comment-content, table.cart .product-remove .remove ' ), 'background-color', 'link_textcolor' );
